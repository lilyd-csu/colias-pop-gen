...
pair_fst$site_pair <- substr(paired_fst$File, 5, 9)
```
...
```{r}
ggplot(data=pair_unique, aes(x=distance, y=slatkin_D))+
...
your_pairs_strings <- apply(pair_unique[, c("site1", "site2")], 1, function(x) paste(sort(x), collapse = "-"))
