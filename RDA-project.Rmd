...
levels(colias_env$site) <- as.factor(c("Babbit Gulch","Carpenter Ranch","Dumont Lake","Fountain Valley","Harbison Meadows","High Trails Ranch","Kebler Pass","D Loukonen Farm","Little Laramie","Schreiner Farm","North Fork Trail","Orchard Creek Ranch","Spring Canyon Park","Soapstone Prairie"))
eco <- colias_env$site
